...
class FeignAuthPropertiesTest {
    ...
    void bindsApplicationDemoConfiguration() throws Exception {
        ...
        FeignAuthProperties.AuthConfig measureAuth = properties.getServices().get("measure").getAuth();
        ...
        FeignAuthProperties.AuthConfig consAuth = properties.getServices().get("cons").getAuth();
        assertThat(consAuth.isApiKey()).isTrue();
        assertThat(consAuth.resolvedHeaderName()).isEqualTo("Authorization");
